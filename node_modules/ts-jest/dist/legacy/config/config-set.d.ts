...
import type { TsConfigCompilerOptionsJson } from 'ts-jest/dist/config/types';
import type { RawCompilerOptions } from 'ts-jest/dist/raw-compiler-options';
import type { TsJestAstTransformer, TsJestTransformOptions, TTypeScript } from 'ts-jest/dist/types';
