export declare const fetchAllExhibitions: (limit?: number, offset?: number) => Promise<any[]>;
...
export declare const searchExhibitions: (query: string, limit?: number, offset?: number) => Promise<any[]>;
export {};
